...
import { _SERVICE as SatslinkerActor, idlFactory as SatslinkerActorIdlFactory } from "../declarations/satslinker/satslinker.did";

export function newSatslinkerActor(agent: Agent): SatslinkerActor {
  return Actor.createActor(SatslinkerActorIdlFactory, {
    canisterId: import.meta.env.VITE_SATSLINKER_CANISTER_ID,
    agent,
  });
}

          ...
          <div class="flex flex-col gap-6">
            <div class="flex flex-col gap-2">
              ...
              <p class="text-md text-gray-140">
                This action is irreversible and it will transfer both: leftover fuel and unclaimed SATSLINK tokens to your
              ...
              <p class="font-semibold text-xs text-errorRed">
                ...
                to claim all unclaimed SATSLINK before continuing.
              </p>
            </div>

      ...
      <div class="flex flex-col gap-4 flex-grow">
        <div class="flex flex-col gap-2">
          <div class="flex items-center justify-between">
            <p class="text-gray-140 text-lg font-thin">I Satslink</p>
        ...
        <Show when={totals.data && fuel()}>
          <div class="flex flex-col">
            <p class="font-semibold text-6xl leading-[50px]">
              {satslink()!.toShortString({ belowOne: 4, belowThousand: 2, afterThousand: 1 })}
            </p>
            <p class="text-gray-140">minimum SATSLINK reward</p>
          </div>
          <div class="flex flex-col">

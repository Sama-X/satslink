...
export const InfoPage = () => {
  ...
  const { poolMembers, fetchPoolMembers, totals } = useSatslinker();

  const satslinkExchangeRate = () => icpSwapUsdExchangeRates["egjwt-lqaaa-aaaak-qi2aa-cai"] ?? E8s.zero();
  const satslinkUSDPrice = () =>
    satslinkExchangeRate()?.toDynamic().toShortString({ belowOne: 4, belowThousand: 2, afterThousand: 2 });

...
export function HomePage() {
  ...
  const { totals, poolMembers, fetchPoolMembers } = useSatslinker();
  ...
  const circulatingSupply = () => totals.data?.totalSatslinkTokenMinted;
  const totalSupply = () => {
              ...
              <div class="flex flex-grow gap-2 items-center">
                ...
                <div class="flex flex-col gap-1">
                  <p class="font-bold text-wrap text-md">
                    SATSLINK <span class="font-light">ICRC-1/2</span>
                  </p>
                  <Copyable text={import.meta.env.VITE_SATSLINK_TOKEN_CANISTER_ID} />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="flex flex-col gap-10 px-5 sm:my-28 lg:px-20">
        ...
        <Show when={totals.data}>
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-y-16">
            <Stat
              data={totals.data!.totalTcyclesSatslinked.toShortString({ belowOne: 4, belowThousand: 2, afterThousand: 0 })}
              title="Total Satslinked TCycles"
            />
            <Stat
              data={totals.data!.currentSatslinkTokenReward.toDynamic().toDecimals(4).toString()}
              title="Current Block SATSLINK Reward"
            />
            ...
            <Show when={totals.data!.currentSatslinkTokenReward.gt(E8s.new(140000n))}>
              <Stat
      ...
      <div class="flex flex-col gap-10 px-5 lg:px-20">
        ...
        <AboutCols>
          <AboutCard
            ...
            desc="SATSLINK is a fair miner - all pool members get a piece of 
            reward from each minted block, proportional to their share. The more 
            ICP you satslink, the bigger your share!"
          />
          <AboutCard
            class="bg-gray-115"
          ...
          <AboutCard
            ...
            desc="Unlike other similar projects, SATSLINK doesn't waste IC's compute power, 
            loading nodes with useless tasks. Instead, it uses special API, 
            which allows it to satslink ICP (cycles) much faster, without 
            any negative impact on the network and the environment!"
          />
          <AboutCard
            class="bg-gray-108"
            title="Fuel Satslinks, You Know"
          ...
          <AboutCard
            ...
            until it reaches 0.0014 SATSLINK per block (~1 SATSLINK a day). This 
